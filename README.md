...
**Full Stack Developer (TypeScript / React / React Native / Node.js)**

- Chernivtsi, Ukraine (Open to Remote / Relocation)
- **Email:** [arsen.hryh@gmail.com](mailto:arsen.hryh@gmail.com)
- **Telegram:** [@lifuss](https://t.me/lifuss)
- **GitHub:** [github.com/Lifuss](https://github.com/Lifuss)
- **LinkedIn:** [linkedin.com/in/arsen-hryhoriak](https://www.linkedin.com/in/arsen-hryhoriak/)
...
_April 2025 – June 2026 (1 year 3 months)_
_Top-tier outstaffing agency delivering software solutions for international startups and enterprise clients._

- **Full Stack Developer** _(August 2025 – June 2026)_
- **React & React Native Developer** _(April 2025 – August 2025)_

Delivered high-quality features and Proof of Concepts (POC) under strict NDA conditions across IoT, Healthcare, AI, and Creator Economy domains:

- **AI-Driven Creator CMS:** Engineered a web-based CMS platform for digital creators that automated fan interactions using LLM APIs (OpenAI/Claude), LangChain, and RAG (Retrieval-Augmented Generation) with `pgvector` for semantic context matching.
- **Healthcare & AI Diagnostics Portal:** Co-developed a Next.js + NestJS web application for medical professionals, enabling the upload and processing of MRI brain scans, and built workflows for AI training data annotation.
- **IoT Smart Energy App (React Native / Expo):** Designed and implemented interactive telemetry dashboards and real-time charts visualizing power consumption, solar panel inputs, and smart socket toggle states.
- **Garment Tracking NFC/QR POC:** Built a Flutter and Supabase-based mobile app verifying garment history, transfer of ownership, and custom credit point assignment via physical NFC chip scanning and QR codes.
...
- **Drink Master API:** Designed a secure RESTful API using Node.js, Express.js, and MongoDB. Wrote Swagger/OpenAPI 3.0 documentation, and acted as Scrum Master, hosting standups and managing the Trello backlog.
- **Money Guard:** Created a responsive personal finance manager with React, Redux, and custom CSS, providing budget categorization and monthly expense visualization.
...
- **Chernivtsi Trade and Economics Institute** (2016 – 2021) | Master’s Degree in Management
...
- **Ukrainian:** Native
- **English:** Upper-Intermediate (B2+) — experienced in writing technical documentation, participating in client calls, and collaborating in English-speaking outstaff teams.

---

## 🖨️ How to Export the HTML Resume to PDF
...
3. Apply the following settings:
   ...
   - **Background graphics:** **Checked** (essential for sidebar colors and accents)
   - **Headers and footers:** **Unchecked** (removes URL and page numbering lines)
4. Click **Save** and choose your destination directory.
